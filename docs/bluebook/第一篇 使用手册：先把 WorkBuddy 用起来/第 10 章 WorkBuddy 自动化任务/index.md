...
::: warning 安居建业内部使用提示
自动化上线前必须明确数据来源、运行账号、工作目录、输出去向、失败回退和责任人。删除、覆盖、外发、审批和投资判断等动作不得默认无人值守执行；应设置人工确认点、幂等保护、运行日志和可停止机制，并先用脱敏样本演练。
:::
...
| 信息整理 | 收集公开信息、生成候选、整理来源、制作发布草稿 | 候选清单、核验表、发布草稿 |
| 知识管理 | 定时整理收藏、会议纪要和灵感，补标签与来源 | 知识卡片、每周回顾、待消化列表 |
| 系统巡检 | 巡检日志、汇总异常、检查依赖和运行结果 | 巡检报告、异常摘要、处理建议 |
| 培训复盘 | 汇总学习材料、练习结果和待解决问题 | 学习清单、复盘记录、问题清单 |
...
| 公开信息候选池 | 定期收集政策、行业话题和公开问题 | 人工筛选、核验并确认是否采用 |
